...
with(df, {
  ...
  plot(datetime, Voltage, type = "l", main = "", xlab = "")
  plot(datetime, Sub_metering_1, type = "l", xlab = "", ylab = "Energy sub metering")
  lines(datetime, Sub_metering_2, col = "red")
  lines(datetime, Sub_metering_3, col = "blue")
  legend("topright", lty = c(1,1,1), col = c("black","red","blue"), legend = names(df)[7:9], cex = 0.65, bty = "n")
  plot(datetime, Global_reactive_power, type = "l", main = "", xlab = "", ylab = "Global Reactive Power")
}) 
